...
document.querySelector("#select_dst_language").addEventvListener('change', function(){
	update_dst_country();
...
function create_modal_text_area() {
	var src_textarea_container$=$('<div id="src_textarea_container"><textarea id="src_textarea"></textarea></div>')
		...
		.offset({top:0.15*window.innerHeight, left:0.7*(window.innerWidth-0.5*window.innerWidth)})
	...
	document.querySelector("#src_textarea").style.color = 'white';
	...
	var dst_textarea_container$=$('<div id="dst_textarea_container"><textarea id="dst_textarea"></textarea></div>')
		...
		.offset({top:0.65*window.innerHeight, left:0.7*(window.innerWidth-0.5*window.innerWidth)})
	...
	document.querySelector("#dst_textarea").style.color = 'white';
...
window.addEventListener('resize', function(event){
	if (document.querySelector("#src_textarea_container")) {
		...
		var src_textarea_container$=$('<div id="src_textarea_container"><textarea id="src_textarea"></textarea></div>')
			...
			.offset({top:0.1*window.innerHeight, left:0.7*(window.innerWidth-0.5*window.innerWidth)})
